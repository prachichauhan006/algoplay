...
function App() {
  ...
  if (page === "selection") return <div><h2>Selection Sort</h2><button onClick={() => setPage("home")}>Back</button></div>
  if (page === "insertion") return <div><h2>Insertion Sort</h2><button onClick={() => setPage("home")}>Back</button></div>
